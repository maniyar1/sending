...
three`
    ...
    want := []slide{slide {SlideType: UNORDERED_LIST, SlideText: "one\ntwo\nthree\n"}}
...
three`
    reader := strings.NewReader(input)
    got := SplitIntoSlides(reader)
    want := []slide{slide {SlideType: ORDERED_LIST, SlideText: "one\ntwo\nthree\n"}}
    if !reflect.DeepEqual(got, want) {
        t.Errorf("got %q, want %q", got, want)
    }
}
...
path/to/svg.svg`
    reader := strings.NewReader(input)
    got := SplitIntoSlides(reader)
    want := []slide{slide {SlideType: SVG, SlideText: "path/to/svg.svg"}}
    if !reflect.DeepEqual(got, want) {
        t.Errorf("got %q, want %q", got, want)
    }
}
...
path/to/img.png`
    reader := strings.NewReader(input)
    got := SplitIntoSlides(reader)
    want := []slide{slide {SlideType: IMAGE, SlideText: "path/to/img.png"}}
    if !reflect.DeepEqual(got, want) {
        t.Errorf("got %q, want %q", got, want)
    }
}
...
thing`
    reader := strings.NewReader(input)
    got := SplitIntoSlides(reader)
    want := []slide{slide {SlideType: PRE, SlideText: "thing\n"}}
    if !reflect.DeepEqual(got, want) {
        t.Errorf("got %q, want %q", got, want)
    }
}
...
func TestSplitIntoSlides(t *testing.T) {
    ...
    reader := strings.NewReader(input)
    got := SplitIntoSlides(reader)
    want := []slide{slide {SlideType: TEXT, SlideText: "one\n"},
    slide {SlideType: TEXT, SlideText: "two\n"},
    slide {SlideType: TEXT, SlideText: "three\n"}}
    if !reflect.DeepEqual(got, want) {
...
func TestSplitIntoSlidesMultiline(t *testing.T) {
    ...
    reader := strings.NewReader(input)
    got := SplitIntoSlides(reader)
    want := []slide{slide {SlideType: TEXT, SlideText: "on\ne\n"},
    slide {SlideType: TEXT, SlideText: "tw\no\n"},
    slide {SlideType: TEXT, SlideText: "thre\ne\n"}}
    if !reflect.DeepEqual(got, want) {
        t.Errorf("splitIntoSlides(reader) = %q, want %q", got, want)
    }
}
